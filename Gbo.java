...
public class Gbo extends JFrame {
	...
	private void errorDialog(Exception e) {
		try {
			...
			JOptionPane.showMessageDialog(this, e.toString(), "Ups... -Unexpected Eingabe", JOptionPane.ERROR_MESSAGE,
					icon);
		} catch (Exception e1) {
			System.err.println("Cant find err.png");
			JOptionPane.showMessageDialog(this, "Missing err.png and " + e.toString(),
					"Ups... -Unexpected Eingabe and -missing Files", JOptionPane.ERROR_MESSAGE);
		}
	}
