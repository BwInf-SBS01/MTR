public class Parser {
  ...
  private String verarbeiten(String eingabe) {
  ...
  private String strichRechnen(String rechnung) {
  ...
  private String nextOperationStrich(String input) {
    String operation = "";
  ...
  private int nextOperationIndexStrich(String input) {
  ...
  private String spezRechnen(String rechnung) {
  ...
  private String nextOperationPunkt(String input) {
    String operation = "";
    for (int i = 0; i < input.length(); i++) {
      if (input.charAt(i) == '*') {
        operation = "mult";
  ...
  private int nextOperationIndexPunkt(String input) {
    int index = input.length();
  ...
  private int lastOperationIndexPunkt(String input) {
    int index = -1;
